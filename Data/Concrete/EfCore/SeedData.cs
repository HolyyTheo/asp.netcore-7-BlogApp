            ...
            if (context != null)
            {
                ...
                if (!context.Users.Any())
                {
                    context.Users.AddRange(
                        new User { UserName = "holyytheo", Name = "Oğuzhan Kandemir", Email = "info@holytheo.com", Password = "123456", Image = "p1.jpg" },
                        new User { UserName = "syma", Name = "Şeyma Kandemir", Email = "info@seyma.com", Password = "123456", Image = "p2.jpg" }
                    );
                    context.SaveChanges();
                }
